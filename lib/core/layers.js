...
export class Embedding extends Module {
  ...
  constructor(parentModule, numEmbeddings, dim) {
    ...
    this.weight = this.context.newTensor('f32', dim, numEmbeddings)
  }
...
export class LayerNorm extends Module {
  ...
  constructor(parentModule, dim) {
    super(parentModule)
    this.weight = this.context.newTensor('f32', dim)
    this.bias = this.context.newTensor('f32', dim)
  }
...
export class Linear extends Module {
  ...
  constructor(parentModule, inputDim, outputDim, { bias = true } = {}) {
    ...
    this.weight = this.context.newTensor('f32', inputDim, outputDim)
    this.bias = bias ? this.context.newTensor('f32', outputDim) : null
  }
